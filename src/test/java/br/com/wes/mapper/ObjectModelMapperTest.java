...
class ObjectModelMapperTest {
    ...
    @Nested
    class MapEntityToVOTest {

        @Test
        @DisplayName("Should map entity to value object")
        ...
        @Test
        @DisplayName("Should map entities to value objects")
        public void mapEntitiesToValueObjects() {
            ...
            PersonVO firstPersonVO = peopleVO.getFirst();
    ...
    @Nested
    class MapVOToEntityTest {

        @Test
        @DisplayName("Should map value object to entity")
        ...
        @Test
        @DisplayName("Should map value objects to entities")
